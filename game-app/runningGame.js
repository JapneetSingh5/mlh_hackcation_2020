...
function setUp() {
  ...
  curHealth = [maxHealth];
  // displays other info
  var d = "Distance to home: " + travelled + " kilometer";
  var w = "Energy left: " + curHealth + "out of" + maxHealth + " ";
  $('.distance').text(d);
  $('.water').text(w);
...
function applyChange(curHealth) {
  ...
  var w = "Health left: " + curHealth + "out of" + maxHealth + " Percent";
  $('.water').html(w);
}
